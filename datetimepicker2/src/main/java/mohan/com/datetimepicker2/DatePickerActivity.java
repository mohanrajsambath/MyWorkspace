...
import mohan.com.datetimepicker2.DateTimeWheel.DateWheel.LoopListener;
import mohan.com.datetimepicker2.DateTimeWheel.DateWheel.LoopView;
...
public class DatePickerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initialiseDateWheel() {
        ...
        yearLoopView = findViewById(R.id.picker_year);
        monthLoopView = findViewById(R.id.picker_month);
        dayLoopView = findViewById(R.id.picker_day);
